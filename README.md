...
🙄 [@scrapnichbot](https://telegram.dog/scrapnichbot) **is the only Telegram RoBot, which is using this repository code**. 🙄😬
...
```sh
git clone https://github.com/OTANCABUL/scrapnih
```
...
## [@scrapnichbot](https://telegram.dog/scrapnichbot)
