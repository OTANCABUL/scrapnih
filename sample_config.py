...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "gbtnyaOtan")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "gbtnyaOtan")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/scrapnichbot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/scrapnichbot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "<b>Managed With 🐒 By @OtanCabul</b>")
